...
class Video extends React.Component {
  ...
  leftOnClick = () => {
    this.videoPlayer.currentTime = this.videoPlayer.currentTime - 15;
  };
  ...
  render() {
    ...
    const muteButton = <button id="mute" onClick={this.muteOnCick} />;
    const noMuteButton = <button id="noMute" onClick={this.muteOnCick} />;
    const playButton = <button id="play" onClick={this.playOrStopOnCLick} />;
    const pauseButton = <button id="pause" onClick={this.playOrStopOnCLick} />;
    return (
      <div>
        <video
          className="video"
